...
import com.alodiga.cms.commons.ejb.ReportEJB;
import com.alodiga.cms.commons.ejb.ReportEJBLocal;
...
import com.cms.commons.models.ParameterType;
import com.cms.commons.models.Report;
import com.cms.commons.models.ReportHasProfile;
import com.cms.commons.models.ReportParameter;
import com.cms.commons.models.ReportType;
...
public class ReportEJBImp extends AbstractDistributionEJB implements ReportEJB, ReportEJBLocal {
    ...
    public List<Report> getReport(EJBRequest request) throws EmptyListException, GeneralException, NullParameterException {
        StringBuilder sqlBuilder = new StringBuilder("SELECT * FROM report");
        Query query = entityManager.createNativeQuery(sqlBuilder.toString(),Report.class);
        List<Report> reports  = (List<Report>) query.setHint("toplink.refresh", "true").getResultList();
        return reports;
    }
