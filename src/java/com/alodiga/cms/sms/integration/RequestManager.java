package com.alodiga.cms.sms.integration;
...
public class RequestManager {
    ...
    public static final String SMS_TELINTEL_INTEGRATION_LOGIN = "kgomez@alodiga.com";
    ...
    public static void main(String[] args) {
        try {
           //sendSMSPostRequest("hola jhonny", "584168079662");
            ...
            sendSMSPostRequest("hola Leonel", "584245398150");
